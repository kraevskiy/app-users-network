...
import { handleTheme } from '../../store/app/app.slice.ts';
...
const Navbar = () => {
	...
	const handlerTheme = () => {
		dispatch(handleTheme(theme === 'light' ? 'dark' : 'light'))
	}

	return (
		<div className="navbar bg-base-200 sticky left-0 top-0 z-10 right-0">
			{/*<div className="flex-none">*/}
			{/*	<button className={cn("btn btn-square btn-sm", {*/}
			{/*		'btn-outline': !isDrawerOpen*/}
			...
			<div className="flex-none ml-auto">
				<label className="swap swap-rotate">
					<input type="checkbox" checked={theme === 'light'} onChange={handlerTheme}/>
